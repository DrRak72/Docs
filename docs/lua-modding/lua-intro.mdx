...
- This is a **_Lua-focused_** tutorial. There may be portions on BP interoperability (eventually), but for the most part this will be pure, untainted Lua 😎 Some concepts will definitely transfer over though.
